...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	\begin{part}{L'oeuvre}
		...
		\begin{chapter}{Implémentation}
			L'analyse conceptuelle étant quelque chose d'extrêmement long à mener à terme, nous avons pris la décision (avec les encouragements de 
			notre enseignant) de nous contenter des quelques schémas présentés ci-dessus, et de commencer à programmer, par peur de subir un 
			manque de temps considérable.
			\begin{section}{Système}
				...
				de cet aspect de l'application, mais également de ce qu'allait donner visuellement notre travail, à savoir une arborescence de 
				fichiers sur la gauche de la fenêtre principale, à la manière d'un Eclipse ou d'un QT Creator, et l'envie de commencer à programmer
				se faisait plus que jamais ressentir, mais quelques petits détails restaient encore à régler.\\
				En effet, l'utilisation de \emph{Qt} ainsi que de l'architecture MVC nous contraint à d'abord nous documenter sur ce que ce 
				...
				projets, qui, comme expliqué plus haut, sont des dossiers contenant un fichier de configuration nommé ".pro" à leur racine (dont 
