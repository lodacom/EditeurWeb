...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	\begin{part}{Conception}
		...
		\begin{chapter}{Diagrammes des classes}
			...
			Lors de la conception de la partie "auto-complétion", nous avons cru possible la création d'une classe dédiée à cette fonctionnalité et ainsi lier celle-ci à notre fenêtre. Effectivement dans la plupart des exemples que nous avons relevés, deux classes étaient présentes. L'une pour le contrôle du curseur de l'utilisateur  et ainsi déclencher l'auto-complétion, et l'autre pour permettre la visualisation du résultat de cette dernière (et ainsi donner des propositions à l'utilisateur).\\
...
{images/classesAutoCompletion.jpg}
	\caption{Classe CentralEditor concernant l'auto-complétion}
