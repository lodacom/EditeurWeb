...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\addcontentsline{toc}{chapter}{Conclusion}
		...
		Ma conclusion: Pour ma part le projet fût une bonne expérience, premièrement il m'a permis de développer mes compétences dans le language
		...
		L'émulation intellectuelle émanant des réunion. C'est ce que je retiendrais le plus de ce projet. N'ayant jusqu'alors mené des projets
		...
		UML, C++, Micromobs, oui, non, correct, faux. Autant de mots qui fusaient dans la pièce comme autant d'arguments pour telle pensée, telle
		théorie.\\
