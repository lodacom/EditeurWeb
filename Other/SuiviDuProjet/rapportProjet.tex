...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	\begin{part}{L'oeuvre}
		...
		\begin{chapter}{Discussion}
			...
			Comme on peut le constater sur le tableau précédent, le cahier des charges est presque complété. Il reste néanmoins l'accès aux manuels,
			la validation \gls{Html} et des sites préfabriqués.\\
			...
			En effet, si l'on regarde le diagramme de Gantt de la page \pageref{flute}, on remarque que nous nous apprêtions à travailler jusqu'à la
			fin du mois de mai ce qui nous aurait laissé le temps de terminer ces fonctionnalités très simples à mettre en place.
