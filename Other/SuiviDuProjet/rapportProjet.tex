...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\begin{section}{À propos de Qt}
		...
		accomplissent telle ou telle tâche, on se sent obligé de les utiliser. D'autant plus que la documentation nous y encourage, transformant de
		de fait \gls{Qt} en élément du langage.\\
